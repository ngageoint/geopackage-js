...
function copyFeatures(options) {
  ...
  return outputGeoPackage.createFeatureTable(table, geometryColumns, columns, boundingBox, srsId).then(function() {
  ...
  return xyzTileUtils.iterateAllTilesInExtent(
    ...
    async function processTileCallback(x, y, z, retriever) {
      ...
      if (tileData != null) {
        ...
        outputGeoPackage.addTile(bytes, tableName, z, y, x);
        tilesProcessedCount++;
