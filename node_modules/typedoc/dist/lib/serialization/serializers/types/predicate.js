...
let PredicateTypeSerializer = class PredicateTypeSerializer extends components_1.TypeSerializerComponent {
    supports(t) {
...
PredicateTypeSerializer = __decorate([
    component_1.Component({ name: 'serializer:predicate-type' })
], PredicateTypeSerializer);
