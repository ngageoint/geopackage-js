 ...
 */
export declare class UserCustomTableReader extends UserTableReader {
    /**
     ...
     */
    createColumnWithResults(index: number, name: string, type: string, max?: number, notNull?: boolean, defaultValue?: DBValue, primaryKey?: boolean): UserCustomColumn;
}
