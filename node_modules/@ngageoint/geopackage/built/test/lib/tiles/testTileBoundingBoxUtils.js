var TileBoundingBoxUtils = require('../../../lib/tiles/tileBoundingBoxUtils').TileBoundingBoxUtils, TileUtils = require('../../../lib/tiles/creator/tileUtilities'), BoundingBox = require('../../../lib/boundingBox').BoundingBox;
require('chai').should();
describe('TileBoundingBoxUtils tests', function () {
    ...
    it('should produce the correct tile bounding box without high precision input bounds', function () {
        var webMercatorBox = new BoundingBox(-20037508.3, 20037508.3, -20037508.3, 20037508.3);
        var tileBox = TileBoundingBoxUtils.webMercatorTileBox(webMercatorBox, 12);
    ...
    it('should clamp bounds outside 3857 bounds', function () {
        var webMercatorBox = new BoundingBox(-20037509, 20037509, -20037509, 20037509);
        var tileBox = TileBoundingBoxUtils.webMercatorTileBox(webMercatorBox, 12);
        tileBox.minLongitude.should.equal(0);
        tileBox.maxLongitude.should.equal(4095);
        tileBox.minLatitude.should.equal(0);
...
//# sourceMappingURL=testTileBoundingBoxUtils.js.map