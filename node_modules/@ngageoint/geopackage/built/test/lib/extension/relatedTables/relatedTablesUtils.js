var DataTypes = require('../../../../lib/db/dataTypes').DataTypes, UserColumn = require('../../../../lib/user/userColumn').UserColumn, DublinCoreType = require('../../../../lib/extension/relatedTables/dublinCoreType').DublinCoreType, DublinCoreMetadata = require('../../../../lib/extension/relatedTables/dublinCoreMetadata').DublinCoreMetadata, SimpleAttributesTable = require('../../../../lib/extension/relatedTables/simpleAttributesTable').SimpleAttributesTable, should = require('chai').should();
...
//# sourceMappingURL=relatedTablesUtils.js.map