...
var fs = require('fs-extra'), should = require('chai').should(), path = require('path')
// , GeoPackage = require('../../../lib/geoPackage')
, Metadata = require('../../../lib/metadata/metadata').Metadata, MetadataDao = require('../../../lib/metadata/metadataDao').MetadataDao;
describe('Metadata tests', function () {
    it('should create a Metadata object', function () {
        var md = new MetadataDao(new geoPackage_1.GeoPackage(null, null, null));
