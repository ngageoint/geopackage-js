...
FeatureDao.prototype.fastQueryWebMercatorBoundingBox = function(boundingBox, featureRowCallback) {
  ...
  var thisGetFeatureRow = this.getFeatureRow.bind(this);
    ...
    [Symbol.iterator]() {
      return {
        next: function() {
          ...
          if (!nextRow.done) {
            var featureRow = thisGetFeatureRow(nextRow.value);
        ...
        next: function() {
          ...
          if (!nextRow.done) {
            ...
            while(!nextRow.done && !geometry) {
              featureRow = thisGetFeatureRow(nextRow.value);
              geometry = verifyFeature(featureRow, srs, projectedBoundingBox);
              if (geometry) {
 ...
 */
FeatureDao.prototype.queryForGeoJSONIndexedFeaturesWithBoundingBox = function(boundingBox) {
        ...
        return {
          next: function() {
            ...
            if (!nextRow.done) {
              ...
              while(!nextRow.done && !geometry) {
                featureRow = thisGetFeatureRow(nextRow.value);
                geometry = verifyFeature(featureRow, srs, boundingBox);
                if (geometry) {
                  var geoJson = {
                    properties: {},
                    geometry: geometry
