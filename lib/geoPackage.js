...
GeoPackage.prototype.createSupporteExtensions = function() {
  var crs = new CrsWktExtension(this.getDatabase());
  crs.getOrCreateExtension();
  var schema = new SchemaExtension(this.getDatabase());
...
GeoPackage.prototype.getFeatureDaoWithGeometryColumns = function (geometryColumns) {
  ...
  var featureTable = tableReader.readFeatureTable(this.connection);
...
GeoPackage.prototype.getAttributeDaoWithContents = function (contents) {
  ...
  return new AttributeDao(this.connection, table);
}
