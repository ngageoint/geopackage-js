...
var SpatialReferenceSystemDao = require('./core/srs').SpatialReferenceSystemDao
  ...
  , VTLayersDao = require('./extension/vt').VTLayersDao
  , VTLayersTable = require('./extension/vt').VTLayersTable ;
...
GeoPackage.prototype.getVTLayerDao = function () {
  var vtLayerTable = new VTLayersTable();
  return new VTLayersDao(this, vtLayerTable);
};

/**
 * Gets the tables from the GeoPackage
 * @param  {GeoPackage}   geopackage open GeoPackage object
 * @param  {Function} callback   called with an error if one occurred and an object containing a 'features' property which is an array of feature table names and a 'tiles' property which is an array of tile table names and a 'attributes' property which is an array of attribute table names
 */
...
GeoPackage.prototype.getTileTables = function () {
  return this.getContentsDao().getTables(ContentsDao.GPKG_CDT_TILES_NAME);
};
...
GeoPackage.prototype.getVectorTileTables = function () {
  return this.getContentsDao().getTables(ContentsDao.GPKG_CDT_VECTORTILES_NAME);
};
