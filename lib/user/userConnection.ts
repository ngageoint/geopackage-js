 ...
 */
export abstract class UserConnection<TColumn extends UserColumn,
	 ...
	 * @return result
	 */
	protected abstract createResult(columns: string[], resultSet: ResultSet, sql: string, selectionArgs: string[]): TResult;
