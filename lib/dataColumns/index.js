 ...
 */
DataColumnsDao.prototype.queryByConstraintName = function (constraintName, dataColumnCallback) {
  return this.queryForEachEqWithFieldAndValue(DataColumnsDao.COLUMN_CONSTRAINT_NAME, constraintName, dataColumnCallback);
};
