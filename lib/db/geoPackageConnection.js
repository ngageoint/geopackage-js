 ...
 * @see {module:db/sqliteAdapter~SqliteAdapter}
 * @class
...
GeoPackageConnection.prototype.registerFunction = function(name, functionDefinition) {
  return this.adapter.registerFunction(name, functionDefinition);
}
...
GeoPackageConnection.prototype.countWhere = function(tableName, where, whereArgs) {
  return this.adapter.countWhere(tableName, where, whereArgs);
}
