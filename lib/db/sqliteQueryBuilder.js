...
module.exports.buildQuery = function(distinct, tables, columns, where, join, groupBy, having, orderBy, limit, offset) {
      ...
      if (object.hasOwnProperty(key)) {
        if (object.toDatabaseValue) {
          ...
          if (typeof object[key] == 'boolean') {
            insertOrUpdate[module.exports.fixColumnName(key)] = object[key] ? 1 : 0;
          } else {
