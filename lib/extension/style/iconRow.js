 ...
 */
IconRow.prototype.getDerivedWidth = async function() {
  var width = this.getWidth();
  if (width === undefined || width === null) {
    width = (await this.getDerivedDimensions())[0];
  }
  return width;
};
 ...
 */
IconRow.prototype.getDerivedHeight = async function() {
  var height = this.getHeight();
  if (height === undefined || height === null) {
    height = (await this.getDerivedDimensions())[1];
  }
  return height;
};
 ...
 * @return {Promise<Number[]>} derived dimensions array with two values, width at index 0, height at index 1
 */
IconRow.prototype.getDerivedDimensions = async function() {
  var width = this.getWidth();
  var height = this.getHeight();
  if (width === undefined || width === null || height === undefined || height === null) {
    var dataWidth;
    var dataHeight;
    var image = await this.getDataImage();
