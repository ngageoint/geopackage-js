 ...
 * @return {Bitmap} icon image or null
 */
...
IconCache.prototype.get = function(iconRowId) {
  var bitmap = this.iconCache[iconRowId];
  if (!!bitmap) {
 ...
 * @param {module:extension/style.IconRow} iconRow icon row
 * @param {Bitmap} image icon image
 * @return {Bitmap} previous cached icon image or null
 */
 ...
 * @param {module:extension/style.IconRow} iconRow icon row
 * @return {Bitmap} removed icon image or null
 */
 ...
 * @return {Promise<Bitmap>} icon image
 */
