...
StyleMappingTable.createColumns = function() {
  ...
  columns.push(UserCustomColumn.createColumn(index, StyleMappingTable.COLUMN_GEOMETRY_TYPE_NAME, DataType.GPKGDataType.GPKG_DT_TEXT, undefined, false, undefined))
  return columns;
};
