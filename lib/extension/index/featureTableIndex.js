      ...
      this.getOrCreateExtension(function(err) {
        ...
        this.getOrCreateTableIndex(function(err, tableIndex) {
          this.createOrClearGeometryIndicies(function(err) {
            callback(null, this.indexTable(tableIndex));
          }.bind(this));
        }.bind(this));
      }.bind(this));
    } else {
...
FeatureTableIndex.prototype.createOrClearGeometryIndicies = function(callback) {
  ...
  .then(function() {
    callback(null, this.clearGeometryIndicies());
  }.bind(this));
};
...
FeatureTableIndex.prototype.updateLastIndexed = function(tableIndex) {
  ...
  return this.tableIndexDao.createOrUpdate(tableIndex);
}
