 ...
 */
GeometryIndexDao.prototype.queryForTableName = function(tableName, eachCallback) {
  return this.queryForEachEqWithFieldAndValue(GeometryIndexDao.COLUMN_TABLE_NAME, tableName, eachCallback);
};
