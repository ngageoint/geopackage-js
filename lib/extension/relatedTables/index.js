...
RelatedTablesExtension.prototype.addRelationship = function(relationship) {
  ...
  .then(function() {
    var mappingTableRelations = this.extendedRelationDao.queryByMappingTableName(relationship.userMappingTable.table_name);
...
RelatedTablesExtension.prototype.createUserMappingTable = function(userMappingTableOrName) {
  console.log('userMappingTableOrName', userMappingTableOrName);
  ...
  console.log('userMappingTable', userMappingTable);
