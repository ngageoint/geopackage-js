...
RelatedTablesExtension.prototype.getMappingDao = function(tableName) {
  return new UserMappingDao(this.getUserDao(tableName), this.geoPackage);
}
...
RelatedTablesExtension.RelationshipBuilder = OptionBuilder([
  'baseTableName',
  'relatedTableName',
  'userMappingTable',
  'mappingTableName',
...
RelatedTablesExtension.prototype.addRelationship = function(relationship) {
  ...
  if (relationship.relatedTable) {
    ...
    relationship.relatedTableName = relatedTable.getTableName();
    relationship.relationName = relatedTable.getRelationName()
  }
