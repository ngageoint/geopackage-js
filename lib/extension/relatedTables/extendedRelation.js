...
ExtendedRelationDao.prototype.getBaseTables = function() {
  var baseTables = this.queryForColumnsInAll(ExtendedRelationDao.COLUMN_BASE_TABLE_NAME);
  return baseTables;
};

ExtendedRelationDao.prototype.getRelatedTables = function() {
  var relatedTables = this.queryForColumnsInAll(ExtendedRelationDao.COLUMN_RELATED_TABLE_NAME);
