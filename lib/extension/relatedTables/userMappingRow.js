...
UserMappingRow.prototype.getBaseIdColumnIndex = function() {
  return this.table.getBaseIdColumnIndex();
}
...
UserMappingRow.prototype.getRelatedIdColumnIndex = function() {
  return this.table.getRelatedIdColumnIndex();
}
