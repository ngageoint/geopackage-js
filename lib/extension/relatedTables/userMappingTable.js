...
UserMappingTable.prototype.getBaseIdColumnIndex = function() {
  return this.getColumnIndex(UserMappingTable.COLUMN_BASE_ID);
}
...
UserMappingTable.prototype.getRelatedIdColumnIndex = function() {
  return this.getColumnIndex(UserMappingTable.COLUMN_RELATED_ID);
}
