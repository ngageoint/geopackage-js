 ...
 */
var MetadataReferenceDao = function(connection) {
...
MetadataReferenceDao.prototype.queryByMetadataAndParent = function (fileId, parentId, rowCallback) {
  ...
  return this.queryForFieldValues(columnValues, rowCallback);
};

MetadataReferenceDao.prototype.queryByMetadata = function(fileId, rowCallback) {
  var columnValues = new ColumnValues();
  columnValues.addColumn(MetadataReferenceDao.COLUMN_MD_FILE_ID, fileId);
  return this.queryForFieldValues(columnValues, rowCallback);
};

MetadataReferenceDao.prototype.queryByMetadataParent = function(parentId, rowCallback) {
  var columnValues = new ColumnValues();
  columnValues.addColumn(MetadataReferenceDao.COLUMN_MD_PARENT_ID, parentId);
  return this.queryForFieldValues(columnValues, rowCallback);
};
