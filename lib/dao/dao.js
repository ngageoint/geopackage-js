...
Dao.prototype.queryForEach = function (rowCallback) {
  var query = sqliteQueryBuilder.buildQuery(false, "'"+this.gpkgTableName+"'");
  var count = 0;
  return this.connection.each(query);
  // return new Promise(function(resolve, reject) {
  //   for (var row of this.connection.each(query)) {
...
Dao.prototype.queryForFieldValues = function (fieldValues, rowCallback) {
  var whereString = this.buildWhereWithFields(fieldValues);
  var whereArgs = this.buildWhereArgsWithValues(fieldValues);
  var query = sqliteQueryBuilder.buildQuery(false, "'"+this.gpkgTableName+"'", undefined, whereString);
  var count = 0;
  return new Promise(function(resolve, reject) {
    for (var row of this.connection.each(query, whereArgs)) {
      rowCallback(null, row);
      count++;
    }
    resolve(count);
...
Dao.prototype.queryJoinWhereWithArgs = function(join, where, whereArgs, columns, rowCallback) {
...
Dao.prototype.queryWhereWithArgsDistinct = function(where, whereArgs, rowCallback) {
...
Dao.prototype.queryWhereWithArgs = function(where, whereArgs, rowCallback) {
  return this.queryWhere(where, whereArgs, undefined, undefined, undefined, undefined, rowCallback);
}

Dao.prototype.queryWhere = function (where, whereArgs, groupBy, having, orderBy, limit, rowCallback) {
...
Dao.prototype.queryForEachEqWithFieldAndValue = function (field, value, rowCallback) {
  return this.queryForEachEqWithField(field, value, undefined, undefined, undefined, rowCallback);
};
...
Dao.prototype.queryForEachEqWithField = function(field, value, groupBy, having, orderBy, rowCallback) {
...
Dao.prototype.queryForAllEqWithField = function(field, value, groupBy, having, orderBy) {
  ...
  var whereArgs = this.buildWhereArgsWithValue(value);
  var query = sqliteQueryBuilder.buildQuery(false, "'"+this.gpkgTableName+"'", undefined, whereString);
  return Promise.resolve(this.connection.all(query, whereArgs));
};
