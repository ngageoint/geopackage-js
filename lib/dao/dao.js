...
Dao.prototype.queryForEqWithField = function(field, value, groupBy, having, orderBy, callback1, callback2) {
  ...
  if (callback2) {
    ...
    var all = this.connection.all(query, whereArgs);
    callback1(null, all);
  }
};
...
Dao.prototype.updateWithValues = function (values, where, whereArgs, callback) {
  ...
  try {
    callback(null, this.connection.run(update.sql, update.args));
  } catch (e) {
    callback(e);
  }
};
...
Dao.prototype.update = function(object, callback) {
  ...
  update += where;
  try {
    callback(null, this.connection.run(update, updateValues));
  } catch (e) {
    callback(e);
  }
};
...
Dao.prototype.createOrUpdate = function(object, callback) {
  ...
  if (!existing) {
    callback(null, this.create(object));
  } else {
