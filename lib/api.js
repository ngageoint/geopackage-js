...
GeoPackageAPI.open = function(gppathOrByteArray, callback) {
  var openPromise = new Promise(function(resolve, reject) {
    ...
    if (!valid) {
      return callback ? callback(new Error('Invalid GeoPackage')) : reject(new Error('Invalid GeoPackage'));
    }

    GeoPackageConnection.connect(gppathOrByteArray)
    ...
    .then(function(geoPackage) {
      GeoPackageValidate.hasMinimumTables(geoPackage, function(err) {
        ...
        return callback ? callback(null, geoPackage) : resolve(geoPackage);
      });
    })
...
GeoPackageAPI.create = function(gppath, callback) {
  ...
  var promise = new Promise(function(resolve, reject) {
    ...
    .then(function(geopackage) {
      callback ? callback(null, geopackage) : resolve(geopackage);
    });
  });
      ...
      featureDao.create(featureRow, function(err, id) {
        ...
        fti.getTableIndex(function(err, tableIndex) {
          ...
          fti.indexRow(tableIndex, id, geometryData, function(err) {
            fti.updateLastIndexed(tableIndex, function(updateLastIndexError) {
