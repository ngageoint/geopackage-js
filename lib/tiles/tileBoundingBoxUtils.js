...
var TileMatrix = require('./matrix/tileMatrix');
...
var _WEB_MERCATOR_HALF_WORLD_WIDTH = proj4('EPSG:4326', 'EPSG:3857').forward([180, 0])[0];
 ...
 */
export function webMercatorTileBox(webMercatorBoundingBox, zoom) {
...
export const WEB_MERCATOR_HALF_WORLD_WIDTH = _WEB_MERCATOR_HALF_WORLD_WIDTH;

export function determinePositionAndScale(geoPackageTileBoundingBox, tileHeight, tileWidth, totalBoundingBox, totalHeight, totalWidth) {
  var p = {};
 ...
 */
export function getWebMercatorBoundingBoxFromXYZ(x, y, zoom, options) {
  var tilesPerSide = module.exports.tilesPerSideWithZoom(zoom);
  var tileSize = module.exports.tileSizeWithTilesPerSide(tilesPerSide);
 ...
 *  @return meters
 */
export function tileSizeWithTilesPerSide(tilesPerSide) {
 ...
 */
export function tilesPerSideWithZoom(zoom) {
  return 1 << zoom;
}
 ...
 *  @return tile grid
 */
export function getTileGridWithTotalBoundingBox(totalBoundingBox, matrixWidth, matrixHeight, boundingBox) {
 ...
 *  @return tile column
 */
export function getTileColumnWithTotalBoundingBox(webMercatorTotalBox, matrixWidth, longitude, max) {
 ...
 *  @return tile row
 */
export function getRowWithTotalBoundingBox(webMercatorTotalBox, matrixHeight, latitude, max) {
 ...
 */
export function getTileBoundingBox(box, tileMatrix, tileColumn, tileRow) {
...
export function getTileGridBoundingBox(matrixSetBoundingBox, tileMatrixWidth, tileMatrixHeight, tileGrid) {
  // Get the tile width
...
export function getXPixel(width, boundingBox, longitude) {
...
export function getLongitudeFromPixel(width, boundingBox, tileBoundingBox, pixel) {
...
export function getYPixel(height, boundingBox, latitude) {
...
export function getLatitudeFromPixel(height, boundingBox, tileBoundingBox, pixel) {
