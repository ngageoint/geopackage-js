...
module.exports.webMercatorProjection = proj4('EPSG:3857');
/**
 ...
 */
module.exports.tileSize = function(tilesPerSide) {
  return (2 * WEB_MERCATOR_HALF_WORLD_WIDTH) / tilesPerSide;
}
 ...
 * @since 1.2.0
 */
module.exports.zoomLevelOfTileSize = function(tileSize) {
  const tilesPerSide = (2 * WEB_MERCATOR_HALF_WORLD_WIDTH) / tileSize;
 ...
 */
module.exports.tileWidthDegrees = function(tilesPerSide) {
 ...
 */
module.exports.tileHeightDegrees = function(tilesPerSide) {
 ...
 * @return {Number} tiles per side
 */
module.exports.tilesPerSide = function(zoom) {
 ...
 * @since 2.0.0
 */
module.exports.tileSizeWithZoom = function(zoom) {
 ...
 * @since 2.0.0
 */
module.exports.toleranceDistance = function(zoom, pixels) {
 ...
 * @since 2.0.0
 */
module.exports.toleranceDistanceWidthAndHeight = function(zoom, pixelWidth, pixelHeight) {
