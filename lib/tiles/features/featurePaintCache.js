 ...
 */
var DEFAULT_STYLE_PAINT_CACHE_SIZE = 100;
...
var FeaturePaintCache = function(size = null) {
  this.cacheSize = size | DEFAULT_STYLE_PAINT_CACHE_SIZE;
  this.paintCache = {};
  this.accessHistory = [];
};
...
FeaturePaintCache.prototype.getFeaturePaint = function(styleRowId) {
  var featurePaint = this.paintCache.get(styleRowId);
  if (!!featurePaint) {
 ...
 * @param {module:tiles/features~FeaturePaint} featurePaint featurePaint
 */
FeaturePaintCache.prototype.setPaintForStyleRow = function(styleRow, type, paint) {
  this.setPaint(styleRow.getId(), type, featurePaint);
};
