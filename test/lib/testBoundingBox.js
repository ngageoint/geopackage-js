...
describe('BoundingBox tests', function() {
  ...
  it('should convert with a projection and bbox where the minimum corner moves', function() {
    ...
    projectionBox.minLongitude.should.be.closeTo(780341.5525948266)
    projectionBox.maxLongitude.should.be.closeTo(780578.9297426236)
    projectionBox.minLatitude.should.be.closeTo(162413.15481310617)
    projectionBox.maxLatitude.should.be.closeTo(162649.66124618147)
  })
