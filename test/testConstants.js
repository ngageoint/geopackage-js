 ...
 */
module.exports.IMPORT_CORRUPT_DB_FILE_NAME =
  module.exports.IMPORT_CORRUPT_DB_NAME + '.' + module.exports.GEO_PACKAGE_EXTENSION;
 ...
 */
module.exports.CREATE_COVERAGE_DATA_DB_FILE_NAME =
  module.exports.CREATE_COVERAGE_DATA_DB_NAME + '.' + module.exports.GEO_PACKAGE_EXTENSION;
 ...
 */
module.exports.IMPORT_COVERAGE_DATA_DB_FILE_NAME =
  module.exports.IMPORT_COVERAGE_DATA_DB_NAME + '.' + module.exports.GEO_PACKAGE_EXTENSION;

/**
 * Import coverage data tiff database file name, located in the test assets
 */
module.exports.IMPORT_COVERAGE_DATA_TIFF_DB_FILE_NAME =
  module.exports.IMPORT_COVERAGE_DATA_TIFF_DB_NAME + '.' + module.exports.GEO_PACKAGE_EXTENSION;
