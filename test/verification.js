module.exports.verifySRS = function (geoPackage) {
  ...
  return (
    !!db.get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['gpkg_spatial_ref_sys']) &&
...
module.exports.verifyContents = function (geoPackage) {
  return !!geoPackage
    .getDatabase()
    .get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['gpkg_contents']);
};
...
module.exports.verifyContentsForTable = function (geoPackage, tableName) {
  ...
  return (
    module.exports.verifyContents(geoPackage) &&
...
module.exports.verifyGeometryColumns = function (geoPackage) {
  var db = geoPackage.getDatabase();
  return (
    !!db.get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['gpkg_geometry_columns']) &&
...
module.exports.verifyGeometryColumnsForTable = function (geoPackage, tableName) {
  return (
    module.exports.verifyGeometryColumns(geoPackage) &&
...
module.exports.verifyTileMatrixSet = function (geoPackage) {
  return !!geoPackage
    .getDatabase()
    .get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['gpkg_tile_matrix_set']);
};

module.exports.verifyTileMatrix = function (geoPackage) {
  var db = geoPackage.getDatabase();
  return (
    !!db.get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['gpkg_tile_matrix']) &&
    !!db.get("SELECT name FROM sqlite_master WHERE type='trigger' AND name=?", [
...
module.exports.verifyDataColumns = function (geoPackage) {
  return !!geoPackage
    .getDatabase()
    .get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['gpkg_data_columns']);
};

module.exports.verifyDataColumnConstraints = function (geoPackage) {
  return !!geoPackage
    .getDatabase()
    .get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['gpkg_data_column_constraints']);
};

module.exports.verifyMetadata = function (geoPackage) {
  var db = geoPackage.getDatabase();
  return (
    !!db.get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['gpkg_metadata']) &&
...
module.exports.verifyMetadataReference = function (geoPackage) {
  var db = geoPackage.getDatabase();
  return (
    !!db.get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['gpkg_metadata_reference']) &&
    !!db.get("SELECT name FROM sqlite_master WHERE type='trigger' AND name=?", [
...
module.exports.verifyContentsId = function (geoPackage) {
  return !!geoPackage
    .getDatabase()
    .get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['nga_contents_id']);
};

module.exports.verifyExtensions = function (geoPackage) {
  return !!geoPackage
    .getDatabase()
    .get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['gpkg_extensions']);
};

module.exports.verifyTableIndex = function (geoPackage) {
  return !!geoPackage
    .getDatabase()
    .get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['nga_table_index']);
};

module.exports.verifyGeometryIndex = function (geoPackage) {
  return !!geoPackage
    .getDatabase()
    .get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['nga_geometry_index']);
};

module.exports.verifyFeatureTileLink = function (geoPackage) {
  return !!geoPackage
    .getDatabase()
    .get("SELECT name FROM sqlite_master WHERE type='table' AND name=?", ['nga_feature_tile_link']);
};
